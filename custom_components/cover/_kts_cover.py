...
Modified by Haifeng for KTS smart solution in Guohao Changfeng Residence
    Added updown state support (closed or open)
"""
from xknx.devices.device import Device
from xknx.devices.remote_value_scaling import RemoteValueScaling
...
class KTSCover(Device):
    ...
    def __init__(self,
        ...
        super(KTSCover, self).__init__(xknx, name, device_updated_cb)

        # another solution for DptBinary position state is using issue#107 xknx@github
        # convert payload before passing to postion remote value
