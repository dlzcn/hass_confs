...
async def async_setup_platform(
    ...
    """Set up switches for the KTS KNX platform."""
    ...
    hass.data[DATA_KNX].xknx.devices.async_add(switch)
    async_add_entities([KNXSwitch(switch)])


class KNXSwitch(SwitchEntity):
    """Representation of a KTS KNX switch."""

    _attr_should_poll = False

    def __init__(self, device: XknxSwitch) -> None:
        """Initialize of KTS KNX switch."""
        self.device = device
